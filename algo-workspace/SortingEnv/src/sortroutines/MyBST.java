 ...
 */
public class MyBST extends Sorter {
    ...
    public void printTree() {
        ...
        arr=new int[totalNumOfNodes];
       indexVal=0;
        if (root == null)
            System.out.println("Tree root is empty !");
        else
            printTree(root);
    }
        ...
        if (parent == null) { // root is node to be deleted; it has one child;
            ...
            if (parent.right == n)
                ...
                throw new RuntimeException(
                        "Unable to locate node to be deleted in relation to its parent");
            }
            n = null;
        }
        return true;
    ...
    public void insert(Integer x) {
        totalNumOfNodes++;
//        System.out.println("######################## "+totalNumOfNodes);
        if (root == null) {
